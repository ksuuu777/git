...
## Автор
Ваше Имя
3. Создание ветви и функционального элемента
Создадим новую ветвь (feature/new_functionality), чтобы добавить функциональность вывода приветствия.
Этап 1: Переход в ветвь и добавление файла
Выполняем команду:
git checkout -b feature/new_functionality
Теперь создадим файл index.html, добавив следующий код:
html
Копировать
<!DOCTYPE html>
<html lang="en">
